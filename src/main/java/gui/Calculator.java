...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	//public Calculator(Text displayText) {
	...
	public void handle(ActionEvent event) {
		    ...
		    String texto = (number1+""+operator+""+number2);
			if (value !="+" | value !="-" | value!="*" | value!="/") {
			    ...
			    displayText.setText("");
			}else if(value == "+" | value.equals("-") | value.equals("*") | value.equals("/")) {
			 operator = value;
			}	
			if(number1 !="" & number2!="") {
				displayText.setText(texto);
			    int result = 0; double result1 = 0;
			    if (operator.equals("+")) {
			        ...
			        result1 = Double.parseDouble(number1) / Double.parseDouble(number2);
			        displayText.setText(String.valueOf(result1));
			    }
